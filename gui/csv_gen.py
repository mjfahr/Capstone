...
def create_document_word_stat_csv(file_name, file_directory, output_directory):
    # Opens text file
    file = open(file_directory + file_name + '.txt', "r", encoding="utf8")
    text = file.read()
    ...
    write_document_word_statistics(filtered_tokens, output_directory)


def create_section_word_count_csv(file_name, file_directory, output_directory):
    # Opens text file
    file = open(file_directory + file_name + '.txt', "r", encoding="utf8")
    text = file.read()
    ...
    # Write CSV for (Index, Word, Frequency)
    write_section_total_word_count(filtered_sections, output_directory)

# def create_important_document_word_stat_csv(file_name, file_directory, output_directory):
#     # Opens text file
#     file = open(file_directory + file_name + '.txt', "r", encoding="utf8")
#     text = file.read()
#
...
#
#     # Write CSV for (Index, Word, Frequency)
#     write_important_document_word_statistics(filtered_tokens, output_directory)